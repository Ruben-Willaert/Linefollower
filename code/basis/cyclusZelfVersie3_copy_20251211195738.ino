...
SoftwareSerial BT(7, 4); // RX | TX wijzigen
//pinnen nog wijzigen 
#define MotorLeftFoward 10
#define MotorLeftBackward 11
#define MotorRightFoward 9
...
void loop()
{
  ...
  if (current - previous >= params.cycleTime)
  {
   ...
   if (normalised[index] > 3000) run = 0;
